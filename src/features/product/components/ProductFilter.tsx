const ProductFilter = ({isOpen}: {isOpen: boolean}) => {
  return (
    <aside className={`absolute md:sticky md:top-35 rounded-2xl h-fit p-8 bg-white w-full max-w-100 transition-all duration-3000 ease-in-out z-50 ${isOpen ? "left-0" : "-left-full"}`}>
